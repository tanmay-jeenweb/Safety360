                    ...
                    <div className="flex items-center relative z-30">
                        ...
                        <div className="relative" id="questions-dropdown">
                            <button
                                ...
                                className={`w-44 flex items-center justify-center px-4 py-2.5 text-sm border-r border-white/10 rounded-none focus:outline-none transition-all duration-200 font-semibold text-white cursor-pointer ${isQuestionsOpen || location.pathname.startsWith("/admin/question-bank") || location.pathname.startsWith("/admin/question-paper") || location.pathname.startsWith("/admin/feedback-question-bank") || location.pathname.startsWith("/admin/feedback-paper") ? "bg-white/15" : "bg-[#253361] hover:bg-white/5"
                                    }`}
                            >
                                <span className="flex items-center gap-2 truncate">
                            ...
                            {isQuestionsOpen && (
                                <div className="absolute left-0 top-full mt-1.5 w-64 bg-white border border-slate-200 rounded-2xl shadow-xl p-2.5 z-50 origin-top-left animate-in fade-in slide-in-from-top-2 duration-200">
                                    <div className="flex flex-col gap-1.5">
                                        ...
                                        {(isAdmin || hasPermission("feedback_question_bank", "read")) && (
                                            <button
                                                onClick={() => {
                                                    navigate("/admin/feedback-question-bank");
                                                    setIsQuestionsOpen(false);
                                                }}
                                                className={`relative group flex items-center gap-2.5 px-3 py-2 rounded-xl transition-all cursor-pointer text-left border border-transparent ${location.pathname.startsWith("/admin/feedback-question-bank")
                                                    ? "bg-orange-50/70 text-orange-700 font-semibold border-orange-100/50"
                                                    : "text-slate-600 hover:bg-slate-50 hover:text-slate-900 hover:border-slate-100"
                                                    }`}
                                            >
                                                <div className={`flex items-center justify-center w-8 h-8 rounded-lg transition-all shadow-sm shrink-0 ${location.pathname.startsWith("/admin/feedback-question-bank") ? "bg-orange-100/80 text-orange-700" : "bg-slate-100/80 text-slate-500"
                                                    }`}>
                                                    <i className="fa-solid fa-clipboard-question text-xs"></i>
                                                </div>
                                                <div className="flex-1">
                                                    <p className="text-sm font-semibold leading-snug">Feedback Question Bank</p>
                                                </div>
                                            </button>
                                        )}

                                        {(isAdmin || hasPermission("feedback_papers", "read")) && (
                                            <button
                                                onClick={() => {
                                                    navigate("/admin/feedback-paper");
                                                    setIsQuestionsOpen(false);
                                                }}
                                                className={`relative group flex items-center gap-2.5 px-3 py-2 rounded-xl transition-all cursor-pointer text-left border border-transparent ${location.pathname.startsWith("/admin/feedback-paper")
                                                    ? "bg-orange-50/70 text-orange-700 font-semibold border-orange-100/50"
                                                    : "text-slate-600 hover:bg-slate-50 hover:text-slate-900 hover:border-slate-100"
                                                    }`}
                                            >
                                                <div className={`flex items-center justify-center w-8 h-8 rounded-lg transition-all shadow-sm shrink-0 ${location.pathname.startsWith("/admin/feedback-paper") ? "bg-orange-100/80 text-orange-700" : "bg-slate-100/80 text-slate-500"
                                                    }`}>
                                                    <i className="fa-solid fa-list-check text-xs"></i>
                                                </div>
                                                <div className="flex-1">
                                                    <p className="text-sm font-semibold leading-snug">Feedback Paper</p>
                                                </div>
                                            </button>
                                        )}
                                    </div>
